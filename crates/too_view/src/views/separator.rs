use too::{layout::Axis, Pixel};

use crate::{
    geom::{Size, Space},
    view::Context,
    DrawCtx, Elements, FilledProperty, LayoutCtx, View, ViewExt,
};
...
impl<T: 'static> View<T> for SeparatorView {
    ...
    fn update(&mut self, ctx: crate::UpdateCtx<T>, args: Self::Args<'_>) -> Self::Response {
        self.axis = args
    }
