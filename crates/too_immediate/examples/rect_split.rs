use too_crossterm::*;
use too_immediate::{App, AppRunner};
use too_renderer::{shapes::Fill, SurfaceMut};
use too_runner::*;
...
impl App for Test {
    fn event(&mut self, event: too_backend::Event, ctx: Context<'_>) {
    ...
    fn render(&mut self, mut surface: SurfaceMut, ctx: Context) {
