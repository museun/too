use crate::{layout::Axis, math::inverse_lerp, Pixel};
...
pub fn split<T: 'static, L, R>(
    ...
    let (main, cross) = match axis {
        Axis::Horizontal => crate::math::Rect::from(rect).split_horizontal(1, ratio),
        Axis::Vertical => crate::math::Rect::from(rect).split_vertical(1, ratio),
    };
